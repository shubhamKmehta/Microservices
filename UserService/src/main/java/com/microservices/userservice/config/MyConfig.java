...
import com.microservices.userservice.config.interceptor.RestTemplateInterceptor;
...
public class MyConfig {
    ...
    public MyConfig(ClientRegistrationRepository clientRegistrationRepository, OAuth2AuthorizedClientRepository oAuth2AuthorizedClientRepository) {
